...
public class GettingStarted {
	...
	private MyGengoClient myGengo;
	
	public GettingStarted() throws MyGengoException
	{
		myGengo = new MyGengoClient(ApiKeys.PUBLIC_KEY, ApiKeys.PRIVATE_KEY, true);
	}
	
	public void test() throws MyGengoException, JSONException
	{
        ...
        response = myGengo.postTranslationJobs(jobList, true);
        System.out.println(response.toString(2));
	}
	
	public static void main(String [] args) throws MyGengoException, JSONException
	{
